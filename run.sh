...
# Build the kernel
$CC $CFLAGS -Wl,-Tkernel.ld -Wl,-Map=kernel.map -o kernel.elf lib/libkern/stdio.c lib/libkern/string.c kernel/riscv32/console.c kernel/riscv32/main.c kernel/riscv32/mm.c kernel/riscv32/proc.c kernel/riscv32/sbi.c kernel/riscv32/trap.c shell.bin.o
